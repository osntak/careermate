...
// =============================================================================
import { el, icon, get, navigate, toastError, Spinner, clear } from '/demo/lib.js';

const ROUTES = [
  { id: 'home', label: '홈', icon: 'home', module: '/demo/pages/home.js' },
  { id: 'profile', label: '프로필', icon: 'user', module: '/demo/pages/profile.js' },
  { id: 'jobs', label: '채용공고', icon: 'briefcase', module: '/demo/pages/jobs.js', countKey: 'jobs' },
  { id: 'applications', label: '지원 현황', icon: 'layers', module: '/demo/pages/applications.js', countKey: 'active_applications' },
  { id: 'documents', label: '문서', icon: 'file', module: '/demo/pages/documents.js', countKey: 'cover_letters' },
  { id: 'interview', label: '면접 준비', icon: 'mic', module: '/demo/pages/interview.js', countKey: 'interview_pending' },
  { id: 'settings', label: '설정', icon: 'settings', module: '/demo/pages/settings.js' },
];
