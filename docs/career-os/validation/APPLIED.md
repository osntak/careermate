...
| 항목 | 위치 | 상태 |
|---|---|---|
| P4 STAR 앵커-우선 | `eop/cover-letter.md` §2 step4 | claude 3모델 만장일치(haiku 반대→문구수정→해소). codex 재확인 미완 |
| 사실 앵커 경계(프레이밍) | `eop/cover-letter.md` §2 step4 | claude 3모델 만장일치. codex 재확인 미완 |
