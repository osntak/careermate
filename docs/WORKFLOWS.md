...
2. 비어 있는 항목을 사용자에게 쉬운 한국어로 안내하고, 이력서/경력기술서/포트폴리오/자기소개서 파일 업로드 또는 정보 입력을 요청한다.
...
9. 저장 결과를 쉬운 한국어로 알리고, 문서 탭에서 확인할 수 있음을 안내한다. 특정 공고용으로 작성했다면 이어서 자기소개서나 면접 준비를 제안한다.
